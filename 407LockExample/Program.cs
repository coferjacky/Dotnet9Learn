namespace _407LockExample 
{
    class Shared
    {
        public static int ShareResource { get; set; } = 0;
            ...
            try
            {
                ...
                for (int? i = 1; i <= Count; i++)
                {
                    ...
                    lock (Shared.lockObject) {
                        ...
                        Console.Write($"shared Resource in Count-up:{Shared.ShareResource} ,");
                        Shared.ShareResource++;
                        //卸载锁                     
                    }
    ...
    class NumbersDownCounter
    {
        ...
        public void CountDown()
        {
            ...
            for (int? j = Count; j >= 1; j--)
            {
                ...
                {
                    //Monitor.Enter(Shared.lockObject);
                     Console.Write($"shared Resource in Count-Down:{Shared.ShareResource} ,");
                     Shared.ShareResource--;
                    //卸载锁
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"shared ShareResource: { Shared.ShareResource}"); 
